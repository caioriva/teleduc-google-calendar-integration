...
/*==========================================================
  ...
  echo("                      <p style=\"text-indent:15px\">".RetornaFraseDaLista($lista_frases,46)." ".RetornaFraseDaLista($lista_frases,47)." - <b>FAPESP</b> ".RetornaFraseDaLista($lista_frases,48)." ".RetornaFraseDaLista($lista_frases,49)." - <b>CNPq</b>.\n");
  /* 50 - Atualmente est� sendo apoiado pela */
  /* 51 - Organiza��o dos Estados Americanos */
  echo("                      <p style=\"text-indent:15px\">".RetornaFraseDaLista($lista_frases,50)." ".RetornaFraseDaLista($lista_frases,51)." - <b>".RetornaFraseDaLista($lista_frases,52)."</b>.\n");
