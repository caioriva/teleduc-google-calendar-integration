...
/*==========================================================
  ...
  echo("        <td valign=\"bottom\" class=\"rodape\" lang=\"pt\"> ".RetornaFraseDaLista($lista_frases_geral, 513).": ".$versao." ".RetornaFraseDaLista($lista_frases_geral, 512)." ".$host."<br> ".date("Y")."  - TelEduc - Todos os direitos reservados. <em lang=\"en\">All rights reserved</em> - NIED - UNICAMP</td>\n");
  echo("      </tr>\n");
  echo("    </table>\n");
