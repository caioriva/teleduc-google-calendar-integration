...
/*==========================================================
  ...
  //include($bibliotecas."register_globals.inc");
  ...
  /*
	 Este comentario estava no codigo
  ...
  */
  ...
  /*
	Esta linha evite que se caia no proximo else. O sistema nao funciona
 	se o fluxo de execucao cair no proximo else.	
  */
  $_SESSION["cod_ferramenta_m"]=$cod_ferramenta;
  //if (session_is_registered("cod_ferramenta_m") && (isset($cod_ferramenta)))
  if (isset($_SESSION["cod_ferramenta_m"]) && (isset($cod_ferramenta)))
  {
  ...
  else //primeira vez que acessa alguma ferramenta que utiliza esse arquivo (material.php)
  {
    if (isset($cod_ferramenta)) {
      ...
      //$_SESSION["cod_ferramenta_m"]=$cod_ferramenta_m;
      //$cod_ferramenta_m  = $cod_ferramenta;
      //$_SESSION['cod_ferramenta_m']=$cod_ferramenta_m;
    }else
