...
/* Código principal */
  ...
  ****************************************************************************** */
  ...
  if ($exibir_grupos)
  {
    ...
    $acessos_grupos = RetornaAcessosGrupos($sock, $cod_ferramenta, $data_iniUT, $data_fimUT);

    $nomes_grupos   = RetornaNomesGrupos($sock);
  }
  ...
  while ($num_tabelas-- > 0)
  {
    ...
    ExibeCabecalho($tam_tabela, $num_tabelas, $diaUT, $SalvarEmArquivo, ($coluna_total = (0 == $num_tabelas)) );
  ...
  ****************************************************************************** */
  ...
  // Corre�o provis�ia para exibi�o das datas
