...
/*==========================================================
  ...
  if (count($foruns)>0)
  {
    echo("<form name=\"mapa\" action=\"forum_grafico_periodo2.php\" target=\"Intermap\" method=\"get\" onsubmit=\"return(Valida());\">\n");
    ...
    // 25 - Exibir:
    echo("    <td colspan=\"2\">".RetornaFraseDaLista($lista_frases,25)."</td>\n");
    echo("  </tr>\n");
