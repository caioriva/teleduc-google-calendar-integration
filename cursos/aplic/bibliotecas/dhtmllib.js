...
function InsereFeedback(msg){
	document.getElementById('feedback').innerHTML = msg;
}

function MostraDivCarregando(){
	var d = document.createElement('div');
	d.setAttribute('class', 'carregando');
	var ampulheta = document.createElement('img');
	ampulheta.setAttribute('src', '../inicial/imgs/loading.gif');
	ampulheta.setAttribute('class', 'ampulheta');
	d.appendChild(ampulheta);
	d.appendChild(document.createTextNode(' Carregando...'));
	document.getElementById('calendar').appendChild(d);
}

function MostraDivInterno(){
	var d = document.createElement('div');
	d.setAttribute('class', 'carregando_interno');
	var ampulheta = document.createElement('img');
	ampulheta.setAttribute('src', '../inicial/imgs/loading.gif');
	ampulheta.setAttribute('class', 'ampulheta');
	d.appendChild(ampulheta);
