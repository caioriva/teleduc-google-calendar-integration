...
/*==========================================================
  ...
  // 25 - Plano de notificaï¿½ï¿½es de novidades alterado com sucesso.
  // 26 - Erro ao alterar o plano de notificações de novidades.
  ...
  */
  ...
  /* Obtï¿½m o plano de notificaï¿½ï¿½es de novidades via e-mail escolhido pelo usuï¿½rio */
  ...
  /* 21 - Escolha o plano de envio de notificaï¿½ï¿½es de novidades para seu e-mail: */
  ...
  /* 22 - Nï¿½o desejo receber notificaï¿½ï¿½es de novidades */
  echo("                        <p>\n");
  echo("                          &nbsp;&nbsp;&nbsp;\n");
