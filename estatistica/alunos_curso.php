...
-------------------------------------------------------------------------------
    ...
    Arquivo : administracao/estatistica/alunos_curso.php
...
*/
 ...
 /*==========================================================
  ...
  echo("          <h4>".RetornaFraseDaLista($lista_frases,155)."</h4>\n");
  ...
  echo("          <tr>\n");
  echo("            <td colspan=4>\n");
  FraseTipoAgrupamento('alunos_curso.php',$agrupar);
  echo("            </td>\n");
  echo("          </tr>\n");

  if (!isset($agrupar) || $agrupar==0)
    ImprimeNumeroDeAlunos($sock,$linha['cod_pasta']);
  else
  {
    ...
    if (is_array($pastas))
    {
      ...
      {
        /* 169 - Categoria */
        echo("          <tr class=\"head\"><td colspan=4>".RetornaFraseDaLista($lista_frases,169).": ");
        echo($linha['pasta']."\n");
        echo("</td></tr>\n");
        ImprimeNumeroDeAlunos($sock,$linha['cod_pasta']);
       }
    ...
    ImprimeNumeroDeAlunos($sock,$cod_pasta_null);
